"""
Django settings for ssim-zang project.
...
SECRET_KEY = '(-&(+fx0_r%uvb03^2^1(mr)nnu#rkm_mtl-jv+zwn_sr!eme4'
...
ROOT_URLCONF = 'ssim_zang_up.urls'
...
WSGI_APPLICATION = 'ssim_zang_up.wsgi.application'
...
DATABASES = {
    'default': {
        ...
        'PASSWORD': 'rkskek',  # 접속할 Database 계정 비밀번호 ex) 1234
